...
CONTENT_RESOURCES: tuple[RoleResource, ...] = (
    ...
    RoleResource(id="devops_consult", type="devops_consult", slug="default"),
    RoleResource(id="infrastructure_management", type="infrastructure_management", slug="default"),
    RoleResource(id="application_development", type="application_development", slug="default"),
    RoleResource(id="application_modernization", type="application_modernization", slug="default"),
    RoleResource(
        id="mobile_application_development",
        type="mobile_application_development",
        slug="default",
    ),
    RoleResource(id="user_centered_design", type="user_centered_design", slug="default"),
    RoleResource(id="overview", type="overview", slug="default"),
    ...
    RoleResource(id="contacts", type="contacts", slug="default"),
