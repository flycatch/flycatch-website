...
from flycatch_api.models import SolutionProduct as BulkModel
...
attach_bulk_routes(router, resource=RESOURCE, model=BulkModel, not_found_key='admin.solution_products.not_found')
