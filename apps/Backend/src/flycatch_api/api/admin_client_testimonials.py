...
from flycatch_api.models import ClientTestimonial as BulkModel
...
attach_bulk_routes(router, resource=RESOURCE, model=BulkModel, not_found_key='admin.client_testimonials.not_found')
