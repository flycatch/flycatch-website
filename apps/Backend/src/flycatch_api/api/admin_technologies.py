...
from flycatch_api.models import Technology as BulkModel
...
attach_bulk_routes(router, resource=RESOURCE, model=BulkModel, not_found_key='admin.technologies.not_found')
