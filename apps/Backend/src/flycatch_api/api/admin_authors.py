...
from flycatch_api.api.bulk_routes import attach_bulk_routes, author_delete_guard
from flycatch_api.db import get_db
from flycatch_api.models import Author as BulkModel
...
attach_bulk_routes(
    ...
    resource=RESOURCE,
    model=BulkModel,
    not_found_key="admin.authors.not_found",
    validate_delete=author_delete_guard,
)
