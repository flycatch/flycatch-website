# Data Model: Application Development Service

## ApplicationDevelopment

Table: `application_developments`.
...
| content_available_in | JSON | default `["en"]` |
| seo | JSON | ContentSeo |
...
Admin list `content_available_in` is the label `En`.
