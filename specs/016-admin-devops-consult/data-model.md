# Data Model: DevOps Consult

## DevOpsConsult

Table: `devops_consults`.
...
| experience_title | string(200) | |
| experience_accordion | JSON | `{title, contents HTML, order}` |
| experience_image_key | string(255) | nullable |
| experience_description | text | HTML |
