...
3. **Administration FE matches** — runtime API client and types MUST be generated from `admin-auth.v2`, `admin-rbac.v1`, `admin-management.v2`, `admin-roles.v1`, and `publish.v2`.
...
| [admin-roles.v1.yaml](./admin-roles.v1.yaml) | Role CRUD and permission matrix | Requires `roles.manage` |
...
| admin-roles.v1 | Implements routes | — | Generated client + Settings / Roles UI |
